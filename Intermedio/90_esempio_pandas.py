...
plt.interactive(True)# cosi i grafici non bloccano lo script

def pulisci_schermo():
    os.system('cls' if os.name == 'nt' else 'clear')

#passo 1: leggiamo i dati dal csv
path=f"C:\Data_Python\Source_Py\Dataset_DataFrame" # type: ignore
dataset = pd.read_csv(f"{path}\EsempioPython.csv") # type: ignore
print(dataset)
